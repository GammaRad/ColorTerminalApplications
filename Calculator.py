...
screenArrayString='\
{ 1}{_39}{ 1}{_23}{ 1}|{ 15}CALCULATOR{ 14}|{ 6}ANSWER{ 1}LOG{ 7}||{~39}|{~23}||{ 3}|{ 3}|{ 3}|{ 3}|{ 3}|{ 3}|{ 3}|{ 3}|{ 3}|{ 3}|\
ANSWER:{ 16}||{ 1}0{ 1}|{ 1}1{ 1}|{ 1}2{ 1}|{ 1}3{ 1}|{ 1}4{ 1}|{ 1}5{ 1}|{ 1}6{ 1}|{ 1}7{ 1}|{ 1}8{ 1}|{ 1}9{ 1}|{ 23}||{_3}|\
{_3}|{_3}|{_3}|{_3}|{_3}|{_3}|{_3}|{_3}|{_3}|{ 23}||{ 7}|{ 7}|{ 7}|{ 7}|{ 7}|{_23}||{ 3}({ 3}|{ 3}){ 3}|{ 3}^{ 3}|{ 3}.{ 3\
}|{ 2}del{ 2}|ANSWER:{ 16}||{ 7}|{ 7}|{ 7}|{ 7}|{ 7}|{ 23}||{_7}|{_7}|{_7}|{_7}|{_7}|{ 23}||{ 7}|{ 7}|{ 7}|{ 7}|{ 7}|{_23}\
||{ 3}+{ 3}|{ 3}{_1}{ 3}|{ 3}ˣ{ 3}|{ 3}÷{ 3}|{ 1}Eval{ 2}|ANSWER:{ 16}||{ 7}|{ 7}|{ 7}|{ 7}|{ 7}|{ 23}||{_7}|{_7}|{_7}|{_7\
}|{_7}|{ 23}||{ 7}|{ 7}|PROMPT:{ 16}|{_23}||{ 2}sin{ 2}|{ 2}cos{ 2}|{ 23}|ANSWER:{ 16}||{ 7}|{ 7}|{ 23}|{ 23}||{_7}|{_7}|{\
 23}|{ 23}||{ 7}|{ 7}|{ 23}|{_23}||{ 2}tan{ 2}|{ 2}log{ 2}|ANSWER:{ 16}|ANSWER:{ 16}||{ 7}|{ 7}|{ 23}|{ 23}||{_7}|{_7}|{_2\
3}|{ 23}||{ 7}|{ 7}|{ 7}|{ 7}|{ 7}|{_23}||{ 1}sinh{ 2}|{ 1}cosh{ 2}|{ 1}tanh{ 2}|{ 1}^(1÷{ 2}|{ 2}abs{ 2}|ANSWER:{ 16}||{ 7\
}|{ 7}|{ 7}|nthroot|{ 7}|{ 23}||{_7}|{_7}|{_7}|{_7}|{_7}|{ 23}||{ 7}|{ 7}|{ 7}|{ 7}|{ 7}|{_23}||{ 3}e{ 3}|{ 3}π{ 3}|{ 3}a{ \
3}|{ 3}!{ 3}|{ 3}i{ 3}|{ 23}||{ 7}|{ 2}pi{ 3}|inverse|{ 7}|complex|{ 23}||{_7}|{_7}|{_7}|{_7}|{_7}|{_23}|'
# THERE IS A SPACE ON THE LEFT OF THE '23' IN THE screenArrayString FOR A REASON. DO NOT DELETE THAT SPACE.

#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
out = []
i = 0
n = len(screenArrayString)
while i < n:
    if screenArrayString[i] == '{':
        char = screenArrayString[i + 1]
        j = i + 2
        while screenArrayString[j] != '}':j += 1
        count = int(screenArrayString[i + 2:j])
        out.append(char * count)
        i = j + 1
    else:
        out.append(screenArrayString[i])
        i += 1
screenArray = [list(''.join(out)[p*65:(p+1)*65]) for p in range(30)]
#The above code is responsible for taking the rle encoded (only for " " "_" "~" characters) string of the calculator, and decoding it into a big string with the rle encoding reversed.
#It then takes the reverse rle encoded string and transforms it into a 2d array, where each list contains a series of length 1 characters from that big reverse rle encoded string
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
PanelString='Last Updated: December 13th 2025 @ 09h:40m:51s'
u=27
v=41
